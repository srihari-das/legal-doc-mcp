...
```bash
# HTTP transport (default - streamable HTTP on port 8000)
python main.py
...
This server is designed for deployment via the [Dedalus Labs](https://www.dedaluslabs.ai) platform:

1. Push this directory to a GitHub repository
2. Go to the [Dedalus Dashboard](https://www.dedaluslabs.ai/dashboard)
3. Click **Add Server** and connect your GitHub repo
4. Point to the `mcp-servers/pdf-compliance-analyzer/` directory
5. No environment variables needed (PyMuPDF runs locally)
6. Click **Deploy**

Once deployed, the server is available as a hosted MCP endpoint.
